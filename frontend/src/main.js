...
pluralCaseList.push( {plural: "deliveryrequests", pascal: "Deliveryrequest"} )
pluralCaseList.push( {plural: "inspectionResults", pascal: "InspectionResult"} )

pluralCaseList.push( {plural: "goodsdeliveries", pascal: "Goodsdelivery"} )


pluralCaseList.push( {plural: "deliveryStatusInquiries", pascal: "DeliveryStatusInquiry"} )
